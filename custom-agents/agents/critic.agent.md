...
tools: ['vscode', 'agent', 'execute/*', 'read/readFile', 'read/terminalSelection', 'read/terminalLastCommand', 'edit', 'search',  'todo', 'io.github.upstash/context7/*', 'copilot-container-tools/*']
